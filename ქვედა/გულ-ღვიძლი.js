...
function მითხარი_ხოლმე_რაც_მოხდება() {
    ...
    function ახალი_მოთხოვნა() {
        ...
        მოთხოვნა.onerror=function(){
            სცადე_მოგვიანებით()
        }
        მოთხოვნა.ontimeout=function(){
            ახალი_მოთხოვნა()
        }
        
        მოთხოვნა.timeout=60000
...
function დაამუშავე_მოსული_ნაქნარები(ნაქნარები){
    for (var ნ in ნაქნარები) {
        ...
        if(ნაქნარი.ტიპი=='დავხატე'){
            var მომხ = მომხმარებლები[ნაქნარი.მქმნელი]
            if(!მომხ){
                continue
            }
            მომხ.მიე_ხატავს()
            ...
            if(ნაქნარი.მონაცემები.გზა){
                if(ნაქნარი.მონაცემები.გზა.length==1){
                    var წერტილი = ნაქნარი.მონაცემები.გზა[0]
                    დაფა.დასვი_წერტილი(წერტილი.ხ, წერტილი.ჯ,
            ...
            მომხ.სახელი=ნაქნარი.მონაცემები
            განაახლე_მომხმარებლების_სია()
        }else if(ნაქნარი.ტიპი=='შემოვედი'){
            მომხმარებლები[ნაქნარი.მქმნელი]=new მომხმარებელი(ნაქნარი.მონაცემები)
            განაახლე_მომხმარებლების_სია()
            ...
            მომხ.ხედვის_არე=ნაქნარი.მონაცემები
            მომხ.შუაწერტილი={
                ხ:Math.floor(მომხ.ხედვის_არე.ხ+
                        მომხ.ხედვის_არე.სიგანე/2),
                ჯ:Math.floor(მომხ.ხედვის_არე.ჯ+
                        მომხ.ხედვის_არე.სიმაღლე/2),
            }
...
var ფუნჯი = {
    ...
    დაასრულე: function(ხ, ჯ) {
        ...
        if(this.გზა.length==1){
            var წერტილი=this.გზა[0]
            დაფა.დასვი_წერტილი(წერტილი.ხ, წერტილი.ჯ, საც.ფერი, საც.სისქე)
        }
    },
}
