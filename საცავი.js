...
function მომე_შესაცვლელი_ფრაგმენტები(ნაქნარი1, ნაქნარი2, ნაქნარი3, უკუძახილი){
    მომე_მოზომილი_ფრაგმენტი(ნაქნარი1.ხ, ნაქნარი1.ჯ, null, function(ნახ1){
        მომე_მოზომილი_ფრაგმენტი(ნაქნარი2.ხ, ნაქნარი2.ჯ, null, function(ნახ2){
            მომე_მოზომილი_ფრაგმენტი(ნაქნარი3.ხ, ნაქნარი3.ჯ, null, function(ნახ3){
                var ნახაზები = [ნახ1]
                if(ნახ1!=ნახ2){
                    ნახაზები.push(ნახ2)
                }
                ...
                უკუძახილი(ნახაზები, ნაქნარი1, ნაქნარი2, ნაქნარი3)
            })
        })
    })
}
...
exports.მიახატე=function(ნახატი){
    ...
    for(var ი=2;ი<გზა.length;ი++){
        // გასაკეთებელია სისქე
        var ნაქ=გზა[ი]
        var წინა_ნაქ1=გზა[ი-1]
        var წინა_ნაქ2=გზა[ი-2]
        
        მომე_შესაცვლელი_ფრაგმენტები(ნაქ, წინა_ნაქ1, წინა_ნაქ2, function(ფრაგმენტები, ნაქ, წინა_ნაქ1, წინა_ნაქ2){
            for(var ფ in ფრაგმენტები){
                var ფრაგმენტი = ფრაგმენტები[ფ]
                
                var ხ=ნაქ.ხ-ფრაგმენტი.ხ,
                    ჯ=ნაქ.ჯ-ფრაგმენტი.ჯ,
                    წინა1_ხ=წინა_ნაქ1.ხ-ფრაგმენტი.ხ,
                    წინა1_ჯ=წინა_ნაქ1.ჯ-ფრაგმენტი.ჯ,
                    წინა2_ხ=წინა_ნაქ2.ხ-ფრაგმენტი.ხ,
                    წინა2_ჯ=წინა_ნაქ2.ჯ-ფრაგმენტი.ჯ
                    
                ფრაგმენტი.კონტ.save()
                ფრაგმენტი.კონტ.strokeStyle=ნახატი.ფერი
                ფრაგმენტი.კონტ.lineWidth=ნახატი.სისქე
                ფრაგმენტი.კონტ.globalAlpha=0.7
                
                ფრაგმენტი.კონტ.beginPath()
                ფრაგმენტი.კონტ.moveTo(წინა2_ხ,წინა2_ჯ)
                ფრაგმენტი.კონტ.lineTo(წინა1_ხ,წინა1_ჯ)
                ფრაგმენტი.კონტ.lineTo(ხ,ჯ)
                ფრაგმენტი.კონტ.stroke()
                
                if(წინა_ნაქ2==გზა[0]){
                    console.log('პირეველი', წინა2_ხ, წინა2_ჯ)
                    ფრაგმენტი.კონტ.moveTo(წინა2_ხ,წინა2_ჯ)
                    ფრაგმენტი.კონტ.lineTo(წინა1_ხ,წინა1_ჯ)
                    ფრაგმენტი.კონტ.stroke()
                }
                
                if(ნაქ==გზა[გზა.length-1]){
                    console.log('ბოლო', ხ, ჯ)
                    ფრაგმენტი.კონტ.moveTo(წინა1_ხ,წინა1_ჯ)
                    ფრაგმენტი.კონტ.lineTo(ხ,ჯ)
                    ფრაგმენტი.კონტ.stroke()
                }
                
                ფრაგმენტი.კონტ.restore()
