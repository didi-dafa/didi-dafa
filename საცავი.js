        ...
        მომე_შესაცვლელი_ფრაგმენტები(ნაქ, წინა_ნაქ, function(ფრაგმენტები, ნაქ1, წინა_ნაქ1){
            for(var ფ in ფრაგმენტები){
                ...
                if(ფრაგმენტი.ჯ>=0){
                    ...
                    ჯ=-ფრაგმენტი.ჯ+ნაქ1.ჯ
                    წინა_ჯ=-ფრაგმენტი.ჯ+წინა_ნაქ1.ჯ
                }
                
                
                
                console.log(ფრაგმენტი.სახელი, ხ, ჯ, წინა_ხ, წინა_ჯ, 
                    ფრაგმენტი.ხ, ფრაგმენტი.ჯ, ნაქ1.ხ, წინა_ნაქ1.ჯ)
