function ჩასვი_სისქის_ასარჩევი(ელემენტი, საწყისი, უკუძახილი){
    var ნახაზი = document.createElement('canvas'),
            ...
            მინიმალური=1, მაქსიმალური=10, კანტი=2
    ...
    გადახატე_ნახაზი()
    //გადახატე_მიმთითებელი(სისქედან_კოორდნატი(საწყისი))
    ...
    function ბოლო_სისქე(){
        ...
        console.log(მინიმალური+(მაქსიმალური-მინიმალური)*ხარისხი)
    ...
    function გადახატე_მიმთითებელი(ხ){
        var მდებარეობა=ხ<კანტი?კანტი:(ხ>ნახაზი.width-კანტი?ნახაზი.width-კანტი:ხ)
    
        ბოლო_ხ=მდებარეობა-კანტი
    
        კონტ.strokeStyle='#0F0'
        კონტ.lineWidth=4
