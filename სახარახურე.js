...
function დაამატე_ისტორიას(მომხმარებელი){
    // თუ ბოლო ჩანაწერი ისევ ამ ადამიანისაა, მარტო კოორდინატების ვანახლებთ.
    if(ისტორია[0]&&
            ისტორია[0].სახელი==მომხმარებელი.სახელი&&
            ისტორია[0].ხ==მომხმარებელი.შუაწერტილი.ხ&&
            ისტორია[0].ჯ==მომხმარებელი.შუაწერტილი.ჯ){
            ისტორია[0].ფერი=მომხმარებელი.ფერი
    }else{
        ისტორია.splice(0,0,{
...
function განაახლე_ისტორია(){
    გააგზავნე('/რა-მოხდა?როდიდან=0', function(ნაქნარები){
        //JSON.s
    })
}
