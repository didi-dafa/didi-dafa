function ჩასვი_ფერის_ასარჩევი(ელემენტი, საწყისი_ფერი, უკუძახილი){
    ...
    for(var ი=0;ი<ნახაზი.width;ი++){
        for(var კ=0;კ<ნახაზი.height;კ++){
            ...
            // გადმოცემული ფერის მონიშვნისთვის ვარჩევთ უახლოეს ფერს
            var დაშორება={
    ...
    გადახატე_მიმთითებელი(ახლო_ფერი.მისამართი.ხ,ახლო_ფერი.მისამართი.ჯ)
