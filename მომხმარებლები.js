...
function მომე_ძველი_სესიით(ძველი_სესიის_იდ){
    for(var მ in სია){
        var მომხ=სია[მ]
        if(მომხ.ძველი_სესიის_იდ===ძველი_სესიის_იდ){
            return მომხ
        }
    }
}
function შექმენი(მოთხ, პასუხ) {
    // გამოვრიცხოთ სესიის დუბლირება
    var ძველი_სესიის_იდ = ნამცხვარი.მომე(მოთხ, 'სესიის-იდ')
    if(ძველი_სესიის_იდ){
        var დუბლირებული_სესია = მომე_ძველი_სესიით(ძველი_სესიის_იდ)
        if(დუბლირებული_სესია){
            return დუბლირებული_სესია
        }
    }
    ...
    var შემოსვლის_დრო = new Date().getTime(),
        ...
        სისქე = +ნამცხვარი.მომე(მოთხ, 'სისქე')
    ...
    var მომხმარებელი = {
        ...
        ფერი:ფერი,
        სისქე:სისქე,
        ძველი_სესიის_იდ:ძველი_სესიის_იდ,
    ...
    console.log('მიეცი მომლოდინეებს',შეფუთული_ნაქნარი)
...
function წაშალე(მომხმარებელი){
    delete სია[მომხმარებელი.სესიის_იდ]
}
